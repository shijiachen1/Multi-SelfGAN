...
from models.build_block_pre import Cell, DisBlock, OptimizedDisBlock
...
class Generator(nn.Module):
    def __init__(self, args):
        ...
        self.cell2 = Cell(args.tea_gf_dim, args.tea_gf_dim, 'bilinear', num_skip_in=1, short_cut=True)
        self.cell3 = Cell(args.tea_gf_dim, args.tea_gf_dim, 'nearest', num_skip_in=2, short_cut=False)
        ...
        # self.bn = nn.BatchNorm2d(args.tea_gf_dim)
    ...
    def forward(self, z, tea=None, to_img=False, tea_model=None):
        ...
        if tea is None:
            ...
            if to_img:
                ...
                _, h3 = self.cell3(tea[1][0], (tea[0][1], tea[1][1]))
