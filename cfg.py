...
def parse_args():
    ...
    parser.add_argument(
        '--load_path',
        # default= './logs/autogan_search_2021_06_22_11_03_12',
        # default = './logs/autogan_search_2021_06_07_19_11_03',
        type=str,
        help='The reload model path')
    parser.add_argument(
        '--teacher_gen_b_path',
        # default= './logs/autogan_cifar10_a_2021_04_09_20_37_29/Model/checkpoint_best.pth',
        # default= './logs/teacher_gen_a_pre_2021_04_15_22_05_49/Model/checkpoint_best.pth',
        default='./logs/train_tea_2021_04_20_15_44_23/Model/checkpoint_best.pth',
        type=str,
        help='The reload model path')
    parser.add_argument(
        '--teacher_gen_b_256_path',
        default= './logs/autogan_cifar10_a/autogan_cifar10_a_2021_04_09_20_37_29/Model/checkpoint_best.pth',
        # default= './logs/teacher_gen_a_pre_2021_04_15_22_05_49/Model/checkpoint_best.pth',
        # default='./logs/train_tea_2021_04_20_15_44_23/Model/checkpoint_best.pth',
        type=str,
        help='The reload model path')
    ...
    parser.add_argument('--tea_df_dim', type=int, default=64,
                        help='The base channel num of disc')
    parser.add_argument('--tea_gf_dim', type=int, default=128,
                        help='The base channel num of disc')
    parser.add_argument(
        '--gen_model',
        type=str,
        default='shared_gan_block',
    ...
    parser.add_argument(
        '--teacher_gen_b',
        type=str,
        default='teacher_gen_a_pre',
        help='path of dis model')
    parser.add_argument(
        '--teacher_gen_a',
        type=str,
        default='teacher_gen_a',
        help='path of dis model')
    parser.add_argument(
        '--controller',
        type=str,
    ...
    parser.add_argument(
        '--controller_block',
        type=str,
        default='controller_block',
        help='path of controller_block')
